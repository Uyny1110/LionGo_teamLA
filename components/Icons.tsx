...
export const Icons = {
  ...
  Diamond: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l8.59 8.59a2.41 2.41 0 0 0 3.41 0l8.59-8.59a2.41 2.41 0 0 0 0-3.41l-8.59-8.59a2.41 2.41 0 0 0-3.41 0Z"/></svg>
  )
};
